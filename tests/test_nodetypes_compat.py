"""Nodetype expectations for openmayahelper.core.nt."""
...
class NodeTypesCompatibilityTests(MayaTestCase):
    ...
    def test_nt_transform_and_joint_are_callable(self):
        ...
        self.assertTrue(callable(transform_cls), "nt.Transform must be callable.")
        self.assertTrue(callable(joint_cls), "nt.Joint must be callable.")
